...
_REGISTRY: dict[str, str] = {
    "katanaml": "data_sources.katanaml_invoices.loader.KatanamlInvoicesDataset",
    "midd": "data_sources.midd.loader.MIDDDataset",
    "sroie": "data_sources.sroie.loader.SROIEDataset",
}
