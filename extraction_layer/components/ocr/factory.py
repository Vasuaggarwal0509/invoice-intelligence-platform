...
_BACKEND_REGISTRY: dict[str, str] = {
    ...
    "tesseract": "extraction_layer.components.ocr.tesseract_backend.TesseractBackend",
    "paddleocr": "extraction_layer.components.ocr.paddleocr_backend.PaddleOCRBackend",
    "doctr": "extraction_layer.components.ocr.doctr_backend.DocTRBackend",
}
