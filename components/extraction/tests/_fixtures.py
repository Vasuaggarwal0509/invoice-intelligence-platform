...
from components.ocr.types import BoundingBox, Line, OCRResult, PageSize


def make_line(text: str, x0: float, y0: float, x1: float, y1: float, confidence: float = 0.95) -> Line:
    return Line(
        text=text,
