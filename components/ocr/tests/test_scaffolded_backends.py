...
from components.ocr.doctr_backend import DocTRBackend
from components.ocr.paddleocr_backend import PaddleOCRBackend
from components.ocr.tesseract_backend import TesseractBackend
