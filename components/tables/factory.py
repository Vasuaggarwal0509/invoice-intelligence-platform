...
_REGISTRY: dict[str, str] = {
    "spatial": "components.tables.spatial.extractor.SpatialTableExtractor",
    "pp_structure": "components.tables.pp_structure_backend.PPStructureTableExtractor",
    "layoutlm": "components.tables.layoutlm_backend.LayoutLMTableExtractor",
}
